			...
			<div class="perfil capitaliza">
				...
				<?php 
					...
					elseif(($usuario!='')and($rol!='admin')){
						...
						echo"<p> Acciones de ABM <a class='link' href='f_materiales.php'>Modificar</a> o <a class='link' href='f_materiales_agregar.php'>Agregar</a></p>";
				...
				if ($rol!='admin'){
					...
					require_once'r_materiales_eliminar.php';
				}
				?>  
	                </table>
				</div>
